---
title: Customization
description: Describes common Clarity theme configuration parameters that can be adjusted via config file or via Front
  Matter section.
lead: Describes common Clarity theme configuration parameters that can be adjusted via config file or via Front Matter
  section.
...
Customization page describes common Clarity configuration parameters which can be specified via configuration file or
...
**Clarity** allows you to set a custom logo in the site header. You may use text, or image, or both. Use the following
...
Clarity uses `#e22d30` as a default highlight color, but you may choose and set any other color.
...
**Clarity** comes with a configurable sidebar that can be on the left, on the right, or disabled. The default layout
...
**Clarity** contains built-in social links in the social widget. In addition to default social links, you may set
...
The search box widget can refer to the results of Google, Bing, and DuckDuckGo searches. By default, Clarity uses
...
especially our [FAQ]({{< relref "/docs/faq.md" >}} "Clarity FAQ") for more instructions.

### Menus

**Clarity** supports multiple menus. The `main` menu is fully responsive and displayed right under the site header. The
...
**Note:** Please keep in mind that Clarity menus don't support nested items i.e. submenus.
...
Clarity uses Open Sans from Google Fonts as a main font. But you can use any other font from Google Fonts if you'd
...
[Edit this page on GitHub](https://github.com/vimux/clarity/blob/master/exampleSite/content/docs/customization.md)
