...
description: This article helps you get started with the Clarity theme, including installation and minimal
  configuration.
lead: This article helps you get started with the Clarity theme, including installation and minimal configuration.
...
Welcome to the Clarity theme documentation. This quick start guide covers Clarity theme installation and minimal
...
Before installing the **Clarity** theme, make sure that you've
...
```sh
git submodule add https://github.com/vimux/clarity.git themes/clarity
```
...
```sh
git clone https://github.com/vimux/clarity.git themes/clarity
```

### Option C: Manual install

If you do not want to use git, you can manually
**[download ZIP](https://github.com/vimux/clarity/archive/master.zip)** and extract it into the `themes/clarity`
...
**Do not copy the [example config](https://github.com/vimux/clarity#configtoml-example) as-is.**
Use only the parameters that you need. The Clarity theme contains required defaults, so you don't need to add all of
...
For information about common customization settings, see [Customization page]({{< relref "/docs/customization.md" >}} "Clarity theme customization").
To view our example configuration, visit [demo config](https://github.com/vimux/clarity/blob/master/exampleSite/config.toml).

[Edit this page on GitHub](https://github.com/vimux/clarity/blob/master/exampleSite/content/docs/getting-started.md)
