...
### Do I need to have prior experience before proceeding with the Clarity theme?

**Yes.** You'll need to be familiar with Hugo before proceeding.
[Our docs section]({{< ref "/docs/_index.md" >}} "Clarity theme documentation") is intended for intermediate to
...
**No.** Clarity theme intentionally does not use any features of the extended version. As such, the extended version of
...
* See [Clarity config.toml example](https://github.com/Vimux/Clarity#configtoml-example) for the full list of
Clarity-specific variables.
...
* See [Clarity Front Matter example](https://github.com/Vimux/Clarity#front-matter-example) for the list of
Clarity-specific Front Matter variables.

### What if I have more questions? Should I create an issue?

**We don't provide personal technical support.** As stated in our
[contributing guidelines](https://github.com/Vimux/Clarity/blob/master/CONTRIBUTING.md), please do not use the issue
...
1. Copy:
    * `./themes/clarity/static/favicon.ico` to `./static/favicon.ico`
    * `./themes/clarity/static/apple-touch-icon.png` to `./static/apple-touch-icon.png`
...
[Edit this page on GitHub](https://github.com/vimux/clarity/blob/master/exampleSite/content/docs/faq.md)
